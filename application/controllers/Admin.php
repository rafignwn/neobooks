...
class Admin extends CI_Controller
{
    ...
    {
        parent::__construct();
        $this->load->model(['ModelBuku', 'ModelUser', 'ModelBooking', 'ModelPinjam']);
        cek_login();
        cek_user();
    }
    ...
    public function index()
    {
        ...
        // Mengupdate stok dan dibooking pada table buku
        ...
        // Menghapus data booking yang sudah lewat dari 2 hari secara otomatis
