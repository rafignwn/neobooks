...
<footer class="sticky-footer bg-white">
    <div class="container my-auto">
        <div class="copyright text-center my-auto">
            <span>Copyright &copy; Neobooks <?= date('Y'); ?></span>
        </div>
    </div>
</footer>
<!-- End of Footer -->
...
<!-- menu active -->
<script>
    var link_menu = document.querySelectorAll("ul#accordionSidebar li.nav-item a.nav-link");
    
    link_menu.forEach(function(link_item) {
        var path_menu = window.location.href;
        if (link_item.href === path_menu) {
